...
PORT="${PORT:-3000}"
LOG_FILE="${LOG_FILE:-/tmp/argocd-extension.log}"
...
log "========================================="
log "ArgoCD Extension Server Starting"
log "========================================="
log "Port: ${PORT}"
...
# Main server loop
while true; do
    # Generate response and pipe to netcat
    {
...
<head>
    ...
    <title>ArgoCD Extension Dashboard</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <div class="logo">🚀</div>
            <h1>ArgoCD Extension</h1>
            <p class="subtitle">Continuous Deployment Dashboard</p>
        </div>
...
EOF
        ...
        <div class="footer">
            <p><strong>ArgoCD Extension Server</strong></p>
