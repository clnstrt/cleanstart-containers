#!/usr/bin/env python3
"""
Simple Flask API for Nginx Reverse Proxy Example
This demonstrates a backend service that nginx can proxy requests to.
"""
...
def index():
    ...
    return jsonify({
        "message": "Nginx Reverse Proxy Backend API",
        "version": "1.0.0",
        "endpoints": {
            "GET /": "API information",
...
if __name__ == '__main__':
    ...
    print(f"Starting Nginx Reverse Proxy Backend API on port {port}")
