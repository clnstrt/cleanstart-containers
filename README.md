...
cleanstart-containers/
├── images/
│   ├── Ruby/sample-project/           # Ruby web application
│   ├── database-examples/web-app/     # Python Flask application
│   ├── node/sample-project/           # Node.js Express application
│   ├── java/sample-project/java-web/  # Java Spring Boot application
│   ├── go/sample-project/go-web/      # Go Gin application
│   └── postgres/sample-project/       # PostgreSQL + Flask application
